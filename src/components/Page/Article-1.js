...
function Article1() {
    return (
        ...
        <h1><i>Le hameçonnage (ou phishing)</i></h1>
        <img className="ArticleImg" src={require("../../assets/theme1-img/t1-img1.webp")}></img>

        <h2>❓ Qu'est-ce qu'un e-mail frauduleux ?</h2>
        {/* <hr /> */}
        <div className="CategoryContent">
            <p>
            L'hameçonnage (ou phishing en anglais) est une arnaque qui vise à voler vos données personnelles en se faisant passer pour une personne de confiance. <br/>Cette arnaque peut être réalisée via différents canaux de communication, par exemple : courriels (emails), page internet...
            </p>
        </div>
        ...
        <div className="CategoryContent">
            <p>
            Les objectifs d'un cybercriminel à attaquer sont nombreux et variés. Ils peuvent être motivés par l'argent, le pouvoir, la vengeance ou simplement le plaisir de causer des dommages.
            <br />
            Les informations demandées concernent généralement :
            <ul className="ArticleList">
                <li>➡️Vol de données</li>
                <li>➡️Désorganisation</li>
                <li>➡️Déstabilisation</li>
                <li>➡️Destruction</li>
            </ul>
            </p>
        </div>
        ...
        <div className="CategoryContent">
            <div className="GridContainer">
                <img className="ContentImg" src={require("../../assets/theme1-img/t1-img3.webp")}></img>

                <div>
                    <p>Afin de vous sensibiliser sur les mails frauduleux, nous allons vous expliquer comment les reconnaître et vous en protégez. Il est important d’apprendre à repérer les arnaques, et ce, avant même de cliquer sur le contenu du message.</p>
                    <br />
                    <p>
                    💡<u>Conseil pour les liens:</u>
                    <br />Vous pouvez vérifier la destination du lien qui est caché derrière
                    ...
                    bas à gauche de votre navigateur.
                    <br />
        ...
        {/* <hr /> */}
        <div className="CategoryContent">
            <p>Lorsque l'auteur de l'escroquerie est identifiable, la victime de l'arnaque sur Internet peut saisir une juridiction civile pour obtenir le remboursement des sommes extorquées et des dommages et intérêts en cas de préjudice.</p>

            <p> En cas de phishing où toute autre forme d'escroquerie, la victime peut porter plainte auprès d'un commissariat. Si l'auteur de l'arnaque sur Internet n'est pas identifiable, la victime peut porter plainte contre escroc. Le tribunal pénal saisi peut non seulement sanctionner l'auteur de l'escroquerie, mais aussi octroyer des dommages et intérêts au particulier arnaqué sur Internet.</p>
            <p> Le particulier arnaqué sur Internet peut toujours opter pour la saisie des tribunaux français, que l'auteur de l'escroquerie se situe en France ou à l'étranger. </p>

            <p>Procédure judiciaire</p>
            <p> À défaut de résolution amiable après l'envoi d'une lettre de mise en demeure, le particulier arnaqué sur Internet peut saisir au choix le tribunal d'instance lorsque le montant du litige est inférieur à 10 000 € pour obtenir réparation. Ou le tribunal pénal pour faire sanctionner l'auteur de l'infraction et obtenir des dommages et intérêts.</p>
            <br />
            <p>
            <p></p>Usurpation d’identité :</p>
            <p>
